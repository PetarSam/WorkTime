      ...
      <View style={styles.container}>
        ...
        <View>
          ...
          <View style={styles.input}>
            ...
            <TextInput
              style={
                dateTo > dateFrom ? styles.textInput : styles.textInputError
              }
              value={dateTo.toDateString()}
              onTouchStart={() => dateChange('to')}
            />
          </View>
        </View>
        <View>
          <Modal isVisible={visible}>
            <View style={styles.modal}>
              <DateTimePicker
                value={usingDate === 'from' ? dateFrom : dateTo}
                onChange={(e, date) =>
                  usingDate === 'from' ? setDateFrom(date) : setDateTo(date)
                }
              />
